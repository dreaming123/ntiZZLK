...
{
    public class CRLSRMControl : CRLBase
    {
        ...
        public CRLSRMControl(string strsrmno, string ipaddress, int port)//构造函数 
        {
        ...
        public bool Startup()
        {
            ...
            {
                log.WriteLog(m_strSRMNo + ": CRL CRLSRMControl Connection Error!" + ex.Message);
                return false;
            }
        }
