namespace WCS
{
    partial class FormAbout
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "物流仓库控制系统";
            ...
            this.labelCopyright.Text = "版权所有：深圳市今天国际物流技术股份有限公司";
            ...
            this.labelCompanyName.Text = "今天国际";
            ...
            this.textBoxDescription.Text = "    仓库控制系统（WCS）是企业管理信息系统的组成部分之一，通常连接在仓库管理系统（WMS）之下。与仓库管理系统不同之处在于，它含有对底层自动设备的控制和管理" +
    "，是针对某一个或一套具体的自动设备运作的基本管理系统。";
            // 
            // okButton
            // 
